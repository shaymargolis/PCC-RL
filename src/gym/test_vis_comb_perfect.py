...
from src.gym.worker.constant_worker import ConstantWorker
...
model = CombiningWorker(
    ...
    [
        ...
        ConstantWorker(env, (40, 300), constant_speed=100)
    ]
)
...
for i in range(CHANGE_TIMES):
    model.workers[1].set_constant_speed(bws[i % 2])
    vis.steps(300, 299, 100)
